...
description = "cosmology: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/cosmology/blob/master/README.md

License
=======
``cosmology`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/cosmology"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'cosmology': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
