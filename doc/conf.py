...
# -*- coding: utf-8 -*-
#
# cosmology documentation build configuration file, created by
...
htmlhelp_basename = 'cosmologydoc'
...
latex_documents = [
  ('index', 'cosmology.tex', 'cosmology Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'cosmology', 'cosmology Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'cosmology', 'cosmology Documentation',
   'Ariel Rokem', 'cosmology', 'One line description of project.',
   'Miscellaneous'),
]
